...
//
    ...
    private void addData(){
        String Value = "Astride Jump"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"astridejump";
        KeyValueDB db = new KeyValueDB(this);
        db.insertKeyValue("1",Value);
        Value = "Burpee"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"burpee";
        db.insertKeyValue("2",Value);
        Value = "Jumping jack"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"jumpingjack";
        db.insertKeyValue("3",Value);
        Value = "Mountain Climber"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"mountainclimber";
        db.insertKeyValue("4",Value);
        Value = "Jump Rope"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"jumprope";
        db.insertKeyValue("5",Value);
        Value = "Knee Pushup"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"kneelingpushup";
        db.insertKeyValue("6",Value);
        Value = "Leg Raise"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"legraise";
        db.insertKeyValue("7",Value);
        Value = "Push Up"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"pushup";
        db.insertKeyValue("8",Value);
        Value = "Dumble Raise"+"---"+"01:00 Min"+"---"+"Rep x 2"+"---"+"dumblelateralraise";
        db.insertKeyValue("9",Value);

        String Val = " " + "--" + " " + "--" + " " + "--" + " " ;
        db.insertKeyValue("userinfo",Val);
        db.close();
    }
}